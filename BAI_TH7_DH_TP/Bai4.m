...
% Tim tich phan cua ham so cho boi bang sau bang 3 cong thuc Newton-Cotes. Sau do tinh sai so tuong doi cua tung ket qua biet tich phan chinh xac la I = 7.2
xx = [-2; -1; 0; 1; 2; 3; 4];
yy = [24; 1; 4; 3; -8; -11; 36];
I = 7.2;
